...
public:
	...
	static irr::gui::IGUIButton* createGUIBtn(sgfEntityManager *mgr, irr::video::ITexture *tex, irr::core::dimension2di bsize, irr::core::position2df pos, wchar_t *tooltiptext);
