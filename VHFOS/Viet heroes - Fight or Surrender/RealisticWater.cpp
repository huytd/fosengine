	...
	WindForce(20.0f),WindDirection(0,1),WaveHeight(0.3f), WaterColor(0.1f, 0.1f, 0.6f, 1.0f), ColorBlendFactor(0.2f), Camera(0)
{
	...
	{
		WaterPixelShader="shaders/Water/Water_ps.hlsl";
		WaterVertexShader="shaders/Water/Water_vs.hlsl";
	}
	else if (VideoDriver->getDriverType()==video::EDT_OPENGL)
	{
		WaterPixelShader="shaders/Water/Water_ps.glsl";
		WaterVertexShader="shaders/Water/Water_vs.glsl";
	}
